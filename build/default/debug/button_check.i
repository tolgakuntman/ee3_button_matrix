...
static _Bool button_already_sent = 0;
...
void SetRowActive(uint8_t row) {
    LATFbits.LATF7 = 1; LATFbits.LATF6 = 1; LATFbits.LATF5 = 1; LATFbits.LATF4 = 1; LATBbits.LATB3 = 1;
    switch (row) {
        case 0: LATFbits.LATF7 = 0; break;
        case 1: LATFbits.LATF6 = 0; break;
        case 2: LATFbits.LATF5 = 0; break;
        case 3: LATFbits.LATF4 = 0; break;
        case 4: LATBbits.LATB3 = 0; break;
    }
}

uint8_t IsColumnPressed(uint8_t col) {
    switch (col) {
        case 0: return !PORTCbits.RC7;
        case 1: return !PORTDbits.RD4;
        case 2: return !PORTDbits.RD5;
        case 3: return !PORTDbits.RD6;
        case 4: return !PORTDbits.RD7;
        default: return 0;
    }
}
    ...
    switch (fsm_state) {
        ...
        case FSM_DEBOUNCE:
            if (IsColumnPressed(pressedColumn)) {
                if (!button_already_sent && ++debounceCounter >= 3) {
                    button_pressed = 1;
                    button_already_sent = 1;
                    fsm_state = FSM_IDLE;
                    TMR2_Stop();
                }
            } else {
